...
class PlayerSearch extends React.Component {
  ...
  renderTableData() {
    return this.state.leaderboardrecords.map((leaderboardrecord, index) => {
       const {position,playerId ,playerName ,winnings, mandatoryCount,optionalCount,previousPosition} = leaderboardrecord //destructuring
       return (
      ...
      <React.Fragment>
       ...
       <div className="exceptions-search" >
         <form>
            ...
            <input className= "leader-search1" type="text" value={this.state.contestNumber} name="contestNumber" onChange={this.handleChange} placeholder="Contest"/>
            <input className= "leader-search1" type="text" value={this.state.tournamentNumber} name="tournamentNumber" onChange={this.handleChange} placeholder="Tournament"/>            
            </div>
